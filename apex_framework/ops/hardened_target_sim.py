from apex_framework.support.gatekeeper import SecureGateway
from apex_framework.red.loot_bag import DataTransport
...
class HardenedTarget:
    ...
    def execute_internal_logic(self):
        ...
        from apex_framework.red.loot_bag import ShadowSmuggler
