...
from apex_framework.ops.authorization import AuthorizationProtocol
from apex_framework.ops.transport import DataTransport
...
class CampaignOrchestrator:
    ...
    """
    def __init__(self, recon: AssetDiscovery, pivot: PivotTunnel):
        self.recon = recon
        self.loot_bag = DataTransport()
        self.pivot = pivot
